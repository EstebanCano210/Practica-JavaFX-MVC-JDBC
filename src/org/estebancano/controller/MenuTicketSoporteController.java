...
import org.estebancano.model.TicketSoporte;
...
public class MenuTicketSoporteController implements Initializable {
    ...
    public void cargarDatos(){
        tblTicket.setItems(listarTickets());
    ...
    public void cargarForm(){
        TicketSoporte ts = (TicketSoporte)tblTicket.getSelectionModel().getSelectedItem();
        if(ts != null){
            ...
            cmbCliente.getSelectionModel().select(obtenerIndedxCliente());
            cmbFactura.getSelectionModel().select(0);
        }
    
    }
    
    public int obtenerIndedxCliente(){
        int index = 0;
        String clienteTbl = ((TicketSoporte)tblTicket.getSelectionModel().getSelectedItem()).getCliente();
    ...
    public void agregarTicket(){
        try {
            conexion = Conexion.getInstance().obtenerConexion();
            String sql = "call sp_AgregarTicket(?,?,?)";
            statement = conexion.prepareStatement(sql);
